...
intersect(colnames(Permits), colnames(InternationalDeclarations))
intersect(colnames(Permits), colnames(DomesticDeclarations))
intersect(colnames(Permits), colnames(RequestForPayment))
intersect(colnames(Permits), colnames(PrepaidTravelCost))

intersect(colnames(InternationalDeclarations), colnames(DomesticDeclarations))
intersect(colnames(InternationalDeclarations), colnames(RequestForPayment))
intersect(colnames(InternationalDeclarations), colnames(PrepaidTravelCost))

intersect(colnames(DomesticDeclarations), colnames(RequestForPayment))
intersect(colnames(DomesticDeclarations), colnames(PrepaidTravelCost))

intersect(colnames(RequestForPayment), colnames(PrepaidTravelCost))


Permits.a2a <- bano.a2a(Permits, relative = TRUE)
DomesticDeclarations.a2a <- bano.a2a(DomesticDeclarations)
InternationalDeclarations.a2a <- bano.a2a(InternationalDeclarations)
PrepaidTravelCost.a2a <- bano.a2a(PrepaidTravelCost)
RequestForPayment.a2a <- bano.a2a(RequestForPayment)
...
permits.union.a2a.rel <- bano.a2a(Permits)
Permits.a2a <- bano.a2a(Permits)
PrepaidTravelCost.a2a <- bano.a2a(PrepaidTravelCost)
RequestForPayment.a2a <- bano.a2a(RequestForPayment)
DomesticDeclarations.a2a <- bano.a2a(DomesticDeclarations)
InternationalDeclarations.a2a <- bano.a2a(InternationalDeclarations)
...
smolDomesticDeclarations <- DomesticDeclarations %>% select(Activity, Amount, BudgetNumber, id, org.role)
smolInternationalDeclarations <- InternationalDeclarations %>% select(Activity, Amount, BudgetNumber, id)
smolRequestForPayment <- RequestForPayment %>% select(Activity, Project, RequestedAmount, Rfp_id)
smolPrepaidTravelCosts <- PrepaidTravelCost %>% select(Activity, Project, RequestedAmount, Rfp_id, Permit.id)
...
smolUnion.a2a <- bano.a2a(smolUnion)
smolPermits.a2a <- bano.a2a(smolPermits)
smolPermits.a2a.rel <- bano.a2a(smolPermits, relative = TRUE)
smolDomesticDeclarations.a2a <- bano.a2a(smolDomesticDeclarations)
smolInternationalDeclarations.a2a <- bano.a2a(smolInternationalDeclarations)
smolRequestForPayment.a2a <- bano.a2a(smolRequestForPayment)
smolPrepaidTravelCosts.a2a <- bano.a2a(smolPrepaidTravelCosts)
